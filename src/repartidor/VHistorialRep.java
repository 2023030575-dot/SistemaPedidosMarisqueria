...
public class VHistorialRep extends javax.swing.JFrame {
    public static VHistorialRep instancia = null;
    PHistorial pHistorial;
    
    private VHistorialRep() {
        initComponents();
        setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
        setResizable(false);
        
        pHistorial = new PHistorial();
    ...
    public static VHistorialRep getInstance() {
        if (instancia == null || !instancia.isDisplayable()) {
            instancia = new VHistorialRep();
        } else {
            instancia.toFront();
