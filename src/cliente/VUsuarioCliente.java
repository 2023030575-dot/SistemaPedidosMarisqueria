...
public class VUsuarioCliente extends javax.swing.JFrame {

   int idUsuario;
   public static VUsuarioCliente instancia = null;
   Verificacion check = new Verificacion();
   ClienteDB client = new ClienteDB();

    private VUsuarioCliente(int idUsuario) {
    ...
    private void CambiarFechaNacimientoDialogo() {
        VCambiarFechaN.getInstance(idUsuario, "cliente").setLocationRelativeTo(null);
        VCambiarFechaN.getInstance(idUsuario, "cliente").setVisible(true);
    }
    ...
    public static VUsuarioCliente getInstance(int id) {
        if (instancia == null || !instancia.isDisplayable()) {
            instancia = new VUsuarioCliente(id);
        } else {
            instancia.toFront();
